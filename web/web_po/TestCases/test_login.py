...
from web.web_po.PageObjects.login_page import LoginPage
from web.web_po.PageObjects.index_page import IndexPage
...
比如我的前一个用例在中间某个页面报错，如果使用同一个浏览器，洗下一个用例就可能找不到页面或元素。
