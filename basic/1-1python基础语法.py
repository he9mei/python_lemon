...
print("hello world!")
print('''hello world!''')
# "D:\Program Files\Python38\python.exe" C:/Users/lipan/PycharmProjects/python_lemon/basic/1-1python基础语法.py
# hello world!
# 也可以直接在cmd輸出：
# -->python C:/Users/lipan/PycharmProjects/python_lemon/basic/1-1python基础语法.py
